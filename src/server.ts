...
// Aplicación web de un único usuario/pareja: no hay cuentas, así que
// reutilizamos una única lista con un identificador fijo.
...
app.listen(config.port, () => {
  console.log(`🛒 Lista de la compra escuchando en http://localhost:${config.port}`);
