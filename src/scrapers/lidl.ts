...
// poder inspeccionar la pagina en vivo desde este entorno (la red de este entorno
// bloquea el dominio): revisalos con las herramientas de desarrollador del
// navegador (F12 -> Elements) sobre https://www.lidl.es/es/ofertas y ajusta las
// constantes de abajo si no devuelven resultados. Si la pagina requiere JS,
// sustituye este scraper por uno basado en Playwright.
