...
// NOTA: mismo caso que los demas scrapers. Pagina de referencia:
// https://www.esclat.cat/ofertes (bloqueada desde este entorno).
// Ajusta los selectores tras inspeccionar la pagina real.
const OFFERS_URL = "https://www.esclat.cat/ofertes";
...
export const esclatScraper: Scraper = {
  store: "esclat",
