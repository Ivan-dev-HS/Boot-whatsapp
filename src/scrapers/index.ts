...
import { bonpreuEsclatScraper } from "./bonpreuesclat";
...
const REAL_SCRAPERS: Scraper[] = [lidlScraper, plusfrescScraper, bonpreuEsclatScraper];
const MOCK_SCRAPERS: Scraper[] = (["lidl", "plusfresc", "bonpreuesclat"] as StoreId[]).map(
  createMockScraper
);
